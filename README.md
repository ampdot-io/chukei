...
Eventually, chukei will be able to automatically take developer and user
feedback to repair issues with the inference setup, coordinate with other
instances of itself, and talk to inference partners to request support.
...
This project is in the process of migrating to OCaml.
The old version is based on Deno:
